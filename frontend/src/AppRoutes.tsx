  ...
  return (
    <ClerkProvider
      ...
      appearance={{
        ...
        elements: {
          card: 'bg-[#101C20]/80 backdrop-blur-xl border border-violet-500/30 shadow-2xl shadow-violet-950/60 !w-full',
          navbar: 'hidden',
          headerTitle: 'text-white text-2xl font-black',
          headerSubtitle: 'text-white/50 font-medium',
          formButtonPrimary: 'bg-violet-600 hover:bg-violet-500 text-white font-black transition-all',
          formFieldInput: '!bg-white/5 !border !border-white/10 !text-white focus:!border-violet-500 rounded-xl transition-colors',
          formFieldLabel: '!text-violet-100 font-medium',
