          ...
          >
            ...
            <div className="px-6 py-5 border-b border-white/10 flex justify-between items-center bg-white/[0.02]">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <ImageIcon className="w-5 h-5 text-[#8B91E3]" />
                Change Avatar
              </h2>
              <button 
                onClick={onClose}
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col items-center justify-center mb-8 relative">
                <div className="relative">
                  <div className="absolute inset-0 bg-[#5E6AD2] rounded-full blur-xl opacity-40 animate-pulse" />
                  <img
                    src={user.imageUrl}
                    alt="Current Avatar"
                    className="w-24 h-24 rounded-full border-4 border-[rgba(94,106,210,0.4)]/50 object-cover shadow-lg relative z-10 bg-[#0f0428]"
                  />
                  {isUpdating && (
              ...
              >
                <Upload className="w-5 h-5 text-[#8B91E3]" />
                Upload Custom Photo
              </Button>
              ...
              <div className="grid grid-cols-3 gap-4">
                {PREBUILT_AVATARS.map((url, i) => (
                  <button
                    ...
                    className="relative group rounded-xl overflow-hidden aspect-square border-2 border-transparent hover:border-[rgba(94,106,210,0.4)]/50 transition-all focus:outline-none"
                  >
