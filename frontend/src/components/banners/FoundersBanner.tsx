    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(94,106,210,0.18) 0%, rgba(139,145,227,0.12) 50%, rgba(217,70,239,0.1) 100%)",
        ...
        >
          ...
          <div className="relative flex items-center gap-3 px-4 py-3">
            <div className="w-7 h-7 rounded-lg bg-[#5E6AD2]/15 border border-[rgba(94,106,210,0.4)]/25 flex items-center justify-center shrink-0">
              <Rocket className="w-3.5 h-3.5 text-[#8B91E3]" />
            </div>
