    ...
    <AnimatePresence>
      {show && (
        <>
          ...
          >
            <div
              className="rounded-2xl border border-[rgba(94,106,210,0.4)]/25 p-4 shadow-2xl shadow-[rgba(94,106,210,0.50)]"
              style={{ background: "linear-gradient(135deg, rgba(94,106,210,0.18) 0%, rgba(10,4,28,0.97) 100%)", backdropFilter: "blur(24px)" }}
            >
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#5E6AD2]/15 border border-[rgba(94,106,210,0.4)]/20 flex items-center justify-center shrink-0">
                  {state === "done"
                    ? <Bell className="w-5 h-5 text-emerald-400" />
                    : <Bell className="w-5 h-5 text-[#8B91E3]" />
                  }
                </div>
              ...
              {state !== "done" && (
                <div className="flex gap-2 mt-3">
                  <Button
                    ...
                    className="flex-1 bg-gradient-to-r from-[#5E6AD2]-600 to-teal-600 hover:from-[#5E6AD2]-500 hover:to-teal-500 text-white font-semibold text-xs h-8 rounded-lg shadow-lg shadow-[rgba(94,106,210,0.40)]"
                  >
