      ...
      {isMaintenance && (
        ...
        >
          ...
          <motion.div 
            ...
            className="relative z-10 max-w-lg bg-[#100726]/80 backdrop-blur-2xl border border-cyan-500/30 p-10 rounded-3xl shadow-[0_0_50px_rgba(139,92,246,0.15)] flex flex-col items-center"
          >
            <div className="w-20 h-20 rounded-full bg-cyan-600/20 border border-cyan-500/30 flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(139,92,246,0.3)]">
              <Wrench className="w-10 h-10 text-cyan-400" />
            </div>
            
            <h1 className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-sky-400 mb-4 text-center">
            ...
            <div className="w-12 h-1 bg-cyan-500/40 rounded-full overflow-hidden">
              <motion.div 
                animate={{ x: ["-100%", "100%"] }}
