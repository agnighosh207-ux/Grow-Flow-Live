  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 text-white/80">
      ...
      <div className="space-y-6">
        <section>
          <h2 className="text-xl font-bold text-cyan-300 mb-2">Data Collection & Handlers</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-cyan-300 mb-2">Supabase Storage</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-cyan-300 mb-2">AI Generation Logs</h2>
