  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 text-white/80">
      ...
      <div className="space-y-6">
        <section>
          <h2 className="text-xl font-bold text-violet-300 mb-2">1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-violet-300 mb-2">2. Subscriptions & Billing</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-violet-300 mb-2">3. Fair Use Policy & Rate Limits</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-violet-300 mb-2">4. Account Suspension & Termination</h2>
