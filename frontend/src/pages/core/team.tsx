  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 pb-20 px-4">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
             <div className="w-10 h-10 rounded-2xl bg-[rgba(94,106,210,0.10)] border border-[rgba(94,106,210,0.20)] flex items-center justify-center">
                <Users className="w-5 h-5 text-[#8B91E3]" />
             </div>
        ...
        {teamCode && (
          <div className="flex items-center gap-3 w-full md:w-auto">
             <div className="flex-1 md:flex-none px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 font-mono text-xs text-white/50 flex items-center justify-between gap-4">
                <span>{teamCode}</span>
                <button onClick={copyInvite} className="hover:text-[#8B91E3] transition-colors">
                   {copied ? <Check className="w-3.5 h-3.5 text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
                </button>
             </div>
             <Button 
                onClick={copyInvite}
                className="bg-[#5E6AD2] hover:bg-[#5E6AD2] text-white font-bold rounded-xl h-11 px-6 shadow-lg shadow-[rgba(94,106,210,0.20)] transition-all hover:scale-[1.02]"
              >
      ...
      {teamCode ? (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.04] to-transparent p-8 space-y-4 shadow-xl">
              <div className="w-10 h-10 rounded-xl bg-[rgba(94,106,210,0.10)] flex items-center justify-center">
                 <Users className="w-5 h-5 text-[#8B91E3]" />
              </div>
              <div>
            ...
            <div className="rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.04] to-transparent p-8 space-y-4 shadow-xl">
              <div className="w-10 h-10 rounded-xl bg-[rgba(94,106,210,0.10)] flex items-center justify-center">
                 <Crown className="w-5 h-5 text-[#8B91E3]" />
              </div>
              <div>
                    ...
                    <tr key={member.id} className="group hover:bg-white/[0.02] transition-all duration-300">
                      ...
                      <td className="px-8 py-6">
                        <span className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] ${
                          member.role === 'owner' 
                            ? 'bg-[rgba(94,106,210,0.10)] text-[#8B91E3] border border-[rgba(94,106,210,0.20)] shadow-[0_0_15px_rgba(94,106,210,0.1)]' 
                        ...
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <div className="w-24 h-1.5 bg-white/5 rounded-full overflow-hidden border border-white/5">
                            <motion.div 
                              ...
                              className={`h-full ${member.role === 'owner' ? 'bg-[#5E6AD2]' : 'bg-[rgba(94,106,210,0.60)]'}`}
                            />
                          </div>
                        </div>
                      </td>
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-b from-[#5E6AD2]/[0.03] to-transparent pointer-events-none" />
          <div className="relative z-10">
            <div className="w-20 h-20 rounded-3xl bg-[rgba(94,106,210,0.10)] border border-[rgba(94,106,210,0.20)] flex items-center justify-center mx-auto mb-8 shadow-glow-sm">
               <Brain className="w-10 h-10 text-[#8B91E3]" />
            </div>
            ...
            <div className="pt-8">
              <Button 
                ...
                className="bg-gradient-to-r from-[#5E6AD2] to-indigo-900 hover:from-[#5E6AD2] hover:to-indigo-900 text-white font-black px-12 h-14 rounded-2xl shadow-2xl shadow-[rgba(94,106,210,0.40)] transition-all hover:scale-105 active:scale-95"
              >
