  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-6 space-y-8 md:space-y-12 pb-24">
        ...
        <div className="relative overflow-hidden rounded-3xl glass-panel-premium p-10 md:p-16 shadow-2xl group">
          ...
          <div className="relative z-10 text-center md:text-left">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-400 font-black uppercase text-[10px] tracking-[0.3em] mb-6 shadow-glow"
            >
          ...
          >
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className={`group w-full bg-black/60 border ${isErrorCode ? 'border-red-500/40' : 'border-white/10'} rounded-2xl p-6 md:p-8 font-mono text-2xl md:text-3xl font-black tracking-tighter text-center transition-all duration-300 hover:border-violet-500/40 shadow-inner`}>
                  ...
                  {!isErrorCode && (
                    <div className="mt-2 text-[10px] text-white/20 uppercase tracking-[0.4em] font-black group-hover:text-violet-400/40 transition-colors">
                      Personal Access Key
                    </div>
                  )}
                </div>
          ...
          >
            <div className="space-y-10 relative z-10">
              ...
              <div className="grid grid-cols-1 gap-8">
                <div className="group">
                  <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em] mb-2 group-hover:text-violet-400/50 transition-colors">Network Reach</p>
                ...
                <div className="group">
                  <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em] mb-2 group-hover:text-violet-400/50 transition-colors">Conversion Rate</p>
                  <div className="flex items-center justify-between">
                    <p className="text-5xl font-black text-white leading-none tracking-tighter">
                      {referralCount}
                    </p>
                ...
                <div className="pt-8 border-t border-white/10 group">
                  <p className="text-[10px] font-black text-violet-400 uppercase tracking-[0.3em] mb-3 glow-bloom">Accumulated Yield</p>
            ...
            {referralCount === 0 && (
              <div className="mt-8 p-6 bg-violet-500/5 border border-dashed border-violet-500/20 rounded-2xl text-center space-y-3">
                <p className="text-[10px] font-black text-violet-400 uppercase tracking-widest">Guidance: Awaiting First Signal</p>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-10">
            <div className="space-y-2">
              <div className="flex items-center gap-3 text-violet-400 font-black uppercase text-[10px] tracking-[0.3em] mb-2">
                <Target className="w-4 h-4" />
                Active Mission
              </div>
              <h3 className="text-3xl font-black text-white tracking-tight">
                Current Threshold: <span className="gradient-text-violet">{target} Referral</span>
              </h3>
        ...
        <div className="space-y-10">
          <div className="flex items-center gap-6">
            <h2 className="text-3xl font-black text-white whitespace-nowrap tracking-tighter italic">REFERRED CREATORS</h2>
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: LinkIcon, title: "Propagation", desc: "Deploy your unique signal across high-density creator networks and niche communities.", color: "text-indigo-400" },
              { icon: UserPlus, title: "Onboarding", desc: "Your network integrates with the GrowFlow infrastructure via your secure gateway.", color: "text-violet-400" },
              { icon: DollarSign, title: "Validation", desc: "Both accounts receive an immediate resource injection upon protocol verification.", color: "text-indigo-400" }
            ].map((step, i) => (
              <motion.div 
                key={i}
