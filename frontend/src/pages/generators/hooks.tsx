...
const HOOK_PATTERN_LABELS = [
 ...
 { type: "Story Opener", color: "bg-[rgba(94,106,210,0.15)] text-[#8B91E3] border-[rgba(94,106,210,0.20)]" },
 ...
 return (
  <PageWrapper maxWidth="md" className="pb-24 md:pb-8">
   ...
   <div
    ...
    style={{
     background: "linear-gradient(135deg, rgba(139,145,227,0.07) 0%, rgba(255,255,255,0.02) 100%)",
    ...
    <Form {...form}>
     <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col sm:flex-row gap-4 items-end">
        ...
        <FormItem className="flex-1 w-full">
         ...
         <FormControl>
          <Input
           ...
           className="bg-black/20 border-white/10 h-11 md:h-12 rounded-xl text-white text-base placeholder:text-white/25 focus-visible:ring-[rgba(94,106,210,0.4)]"
           {...field}
          />
         </FormControl>
         <FormMessage />
       ...
       render={({ field }) => (
        <FormItem className="w-full sm:w-44">
         ...
         <Select onValueChange={field.onChange} defaultValue={field.value}>
          <FormControl>
           <SelectTrigger className="bg-black/20 border-white/10 text-white focus:ring-[rgba(94,106,210,0.40)] rounded-xl h-11 md:h-12 text-base">
            <SelectValue />
           </SelectTrigger>
          </FormControl>
          <SelectContent className="bg-[#0f0a1e] border-white/10">
           <SelectItem value="Casual" className="text-white/80 focus:text-white focus:bg-[rgba(94,106,210,0.20)]">Casual</SelectItem>
           <SelectItem value="Professional" className="text-white/80 focus:text-white focus:bg-[rgba(94,106,210,0.20)]">Professional</SelectItem>
           <SelectItem value="Aggressive" className="text-white/80 focus:text-white focus:bg-[rgba(94,106,210,0.20)]">Aggressive</SelectItem>
          </SelectContent>
         </Select>
         <FormMessage />
        </FormItem>
      ...
      <Button
       type="submit"
       disabled={isLoading}
       className="w-full sm:w-auto h-12 bg-[#5E6AD2] hover:bg-[#5E6AD2] text-white text-base font-semibold shadow-lg shadow-[rgba(94,106,210,0.40)] rounded-xl px-6"
      >
