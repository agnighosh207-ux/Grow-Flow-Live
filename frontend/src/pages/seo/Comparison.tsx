  ...
  return (
    <PageWrapper maxWidth="lg" className="py-20 space-y-24">
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-white/[0.03]">
              ...
              <th className="p-8 text-[#8B91E3] font-black italic text-xl text-center bg-[rgba(94,106,210,0.5)]">GrowFlow AI</th>
          ...
          <tbody className="divide-y divide-white/5">
            {features.map((f) => (
              <tr key={f.name} className="hover:bg-white/[0.01] transition-colors">
                ...
                <td className="p-8 text-center bg-[rgba(94,106,210,0.5)]">
                   {f.gf === true ? <Check className="w-6 h-6 text-[#8B91E3] mx-auto" /> : <span className="text-[#8B91E3] font-bold">{f.gf}</span>}
                </td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="p-8 rounded-3xl bg-[rgba(94,106,210,0.5)] border border-[rgba(94,106,210,0.10)] space-y-6">
          ...
          <ul className="space-y-4">
            {config.ourAdvantages.map(adv => (
              <li key={adv} className="flex items-center gap-3 text-white/70">
                <Check className="w-5 h-5 text-[#8B91E3] shrink-0" />
                {adv}
              </li>
            ))}
          </ul>
      ...
      <div className="p-10 rounded-3xl bg-gradient-to-br from-[#5E6AD2]/20 to-indigo-600/20 border border-[rgba(94,106,210,0.30)] text-center space-y-4">
      ...
      <div className="text-center p-16 rounded-[40px] bg-gradient-to-r from-zinc-900 to-black border border-white/5 space-y-8">
        ...
        <Button 
          ...
          className="h-16 px-12 rounded-2xl bg-[#5E6AD2] hover:bg-[#5E6AD2] text-white font-black text-xl shadow-glow transition-all"
        >
          START FOR FREE
        </Button>
      </div>
