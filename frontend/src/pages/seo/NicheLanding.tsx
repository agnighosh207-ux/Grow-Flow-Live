    ...
    <PageWrapper maxWidth="lg" className="py-20 space-y-24">
      ...
      <div className="text-center space-y-8 max-w-3xl mx-auto">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[rgba(94,106,210,0.10)] border border-[rgba(94,106,210,0.20)] text-[#8B91E3] text-xs font-black uppercase tracking-widest"
        >
        ...
        >
          Generate 30 Days of <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5E6AD2] to-indigo-500">{config.name}</span> Content in Minutes
        </motion.h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {config.features.map((f, i) => (
          ...
          >
            <div className="w-12 h-12 rounded-2xl bg-[rgba(94,106,210,0.10)] flex items-center justify-center text-[#8B91E3]">
      ...
      {/* CTA Section */}
      <div className="p-12 rounded-[40px] bg-gradient-to-br from-[#5E6AD2] to-indigo-700 text-center space-y-8 shadow-2xl relative overflow-hidden">
        ...
        <Button 
          ...
          variant="secondary"
          onClick={() => navigate("/sign-up")}
          className="h-16 px-12 rounded-2xl bg-white text-[#8B91E3] font-black text-xl hover:bg-zinc-100 transition-all shadow-xl"
        >
