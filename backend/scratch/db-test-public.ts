...
async function test() {
  try {
    console.log("Checking users table columns in 'public' schema...");
    ...
    console.log("Existing columns in public.users:", columnNames);
    ...
    console.log("Checking referrals table in 'public' schema...");
