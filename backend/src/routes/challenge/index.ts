  ...
  try {
    ...
    const svg = `
      <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Content -->
        <text x="600" y="200" font-family="Arial" font-size="24" font-weight="900" fill="#06b6d4" text-anchor="middle" letter-spacing="8 uppercase">CERTIFICATE OF ACHIEVEMENT</text>
        ...
        <text x="600" y="380" font-family="Arial" font-size="84" font-weight="900" fill="#ffffff" text-anchor="middle" italic="true">${name.toUpperCase()}</text>
        
        <line x1="300" y1="410" x2="900" y2="410" stroke="rgba(255,255,255,0.1)" stroke-width="2" />
        
        <text x="600" y="480" font-family="Arial" font-size="20" font-weight="500" fill="rgba(255,255,255,0.6)" text-anchor="middle" width="800">
